...
def train():
    ...
    cnn4.compile(loss=keras.losses.categorical_crossentropy, optimizer=keras.optimizers.Adam(lr=learning_rate),
                  metrics=['accuracy'])

    ##TRAIN##
    hist = cnn4.fit(x_train, y_train, batch_size=batch_size, epochs=epochs, verbose=2,
